...
namespace webapp.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_reservation,id_event,id_user")] Reservation reservation)
        {
            ...
            ViewBag.id_user = new SelectList(db.AspNetUsers, "Id", "Email", reservation.id_user);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_reservation,id_event,id_user")] Reservation reservation)
        {
            if (ModelState.IsValid)
            {
